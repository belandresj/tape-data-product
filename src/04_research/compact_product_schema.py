...
from all_feature_month_schema import FEATURES, REASONS, PRIMITIVES, field_metadata

LAYOUT_VERSION = 'tape_product_compact_v1'
FEATURE_CONTRACT = 'tape_data_product_v1'
KEYS = ('session_date', 'symbol', 'interval_end_ns')
DISCOVERY_FIELDS = ('first_discovery_endpoint_ns', 'discovery_received_at_ns', 'discovery_timing_basis', 'discovery_provenance_hash')
FEATURE_SCHEMA = pa.schema([
    ...
    pa.field('midpoint_change_age_p90_seconds_60s_reason_mask', pa.int64(), nullable=False),
    ...
    pa.field('midpoint_change_age_p90_seconds_300s_reason_mask', pa.int64(), nullable=False),
    pa.field('movement_mean_to_spread_300s_reason_mask', pa.int64(), nullable=False),
...
SUPPORT_SCHEMA = pa.schema([
    ...
    pa.field('state_pre_halt_observation_fraction_60s', pa.float64(), nullable=True),
    ...
    pa.field('state_pre_halt_observation_fraction_300s', pa.float64(), nullable=True),
    ...
    pa.field('midpoint_change_age_observation_count_60s', pa.int64(), nullable=True),
    ...
    pa.field('midpoint_change_age_observation_count_300s', pa.int64(), nullable=True),
...
def dictionary():
    return dict(layout_version=LAYOUT_VERSION, feature_contract=FEATURE_CONTRACT,
        feature_schema_hash=FEATURE_SCHEMA_HASH, support_schema_hash=SUPPORT_SCHEMA_HASH,
        features=field_metadata(), primitives=PRIMITIVES, reason_bits=REASONS,
