"""Test-only scalar reference retained for differential validation."""
import math
import re
...
from tape_data_product.contracts.registry import feature_registry, AGES
from tape_data_product.contracts.reasons import Reason, HISTORY_REASONS, validate_value
from tape_data_product.contracts.schemas import BASE_SCHEMA, feature_schema, support_schema
