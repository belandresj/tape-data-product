...
The report commands consume verified releases or saved, identity-bound numerical tables:

```text
tape-product report aggregate ...
tape-product report population ...
tape-product report activity-population ...
tape-product report render ...
tape-product report verify ...
```
