# Tape Data Product — Developer Guide
...
No license grant has been added. Existing source notices are preserved; no root license file was found in the source checkout. A public/open-source license requires an explicit owner decision. Raw data, cached market data, and detailed vendor-derived feature rows are excluded. The private repository includes the report’s empirical figures and aggregate research summaries; their inclusion does not grant redistribution rights or authorize public release.
